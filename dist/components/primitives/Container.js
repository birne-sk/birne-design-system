...
const Section = React.forwardRef(({ className, background, padding, as: Component = "section", ...props }, ref) => {
    return (_jsx(Component, { ref: ref, className: cn(sectionVariants({ background, padding, className })), ...props }));
});
...
const Container = React.forwardRef(({ className, size, ...props }, ref) => {
...
const Box = React.forwardRef(({ className, variant, padding, ...props }, ref) => {
    return (_jsx("div", { ref: ref, className: cn(boxVariants({ variant, padding, className })), ...props }));
});
Box.displayName = "Box";
// ============================================
...
const Stack = React.forwardRef(({ className, direction, gap, align, justify, ...props }, ref) => {
    return (_jsx("div", { ref: ref, className: cn(stackVariants({ direction, gap, align, justify, className })), ...props }));
});
