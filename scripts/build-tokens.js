...
// ============================================
// Generate Components Inline CSS Markdown
// ============================================

function generateComponentsInlineMarkdown() {
  return `# Birne Komponenty — Inline CSS
...
|---------|-------------|------------|
| default | Na bielom pozadi | \`background: ${colors.birneBlack[5]}; color: ${colors.birneBlack[100]};\` |
| purple | Fialovy akcent | \`background: ${colors.birnePurple[40]}; color: ${colors.birneBlack[100]};\` |
| lemon | Zlty akcent | \`background: ${colors.birneLemon[100]}; color: ${colors.birneBlack[100]};\` |
| dark | Tmavy | \`background: ${colors.birneBlack[100]}; color: #FFFFFF;\` |
| onDark | Na tmavom pozadi | \`background: rgba(255,255,255,0.15); color: #FFFFFF;\` |
| onGray | Na sivom pozadi | \`background: #FFFFFF; color: ${colors.birneBlack[100]};\` |
| glass | Na fotkach/gradientoch | \`background: rgba(255,255,255,0.80); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.20); color: ${colors.birneBlack[100]};\` |
...
| Variant | Inline CSS |
|---------|------------|
| primary | \`background: ${colors.birneLemon[100]}; color: ${colors.birneBlack[100]}; border: 1px solid ${colors.birneBlack[100]};\` |
| secondary | \`background: ${colors.birneBlack[100]}; color: ${colors.birnePurple[100]}; border: 1px solid ${colors.birneBlack[100]};\` |
| soft | \`background: ${colors.birneBlack[2]}; color: ${colors.birneBlack[100]}; border: 1px solid ${colors.birneBlack[100]};\` |
| ghost | \`background: transparent; color: ${colors.birneBlack[100]}; border: none;\` |

### Velkosti

| Size | Height | Padding | Font size | Inline CSS |
|------|--------|---------|-----------|------------|
| sm | 32px | 0 16px | ${typography.fontSize.sm} | \`height: 32px; padding: 0 16px; font-size: ${typography.fontSize.sm};\` |
| md | 40px | 0 24px | ${typography.fontSize.base} | \`height: 40px; padding: 0 24px; font-size: ${typography.fontSize.base};\` |
| lg | 48px | 0 32px | ${typography.fontSize.md} | \`height: 48px; padding: 0 32px; font-size: ${typography.fontSize.md};\` |

### Priklad: Primary button, lg

\`\`\`html
<a href="#" style="display: inline-flex; align-items: center; justify-content: center; height: 48px; background: ${colors.birneLemon[100]}; color: ${colors.birneBlack[100]}; border: 1px solid ${colors.birneBlack[100]}; border-radius: 9999px; padding: 0 32px; font-family: 'Conforto', serif; font-size: ${typography.fontSize.md}; font-weight: 400; text-decoration: none;">Text</a>
\`\`\`
...
|---------|-------------|------------|
| default | Na bielom pozadi | \`background: ${colors.birneBlack[5]}; color: ${colors.birneBlack[100]};\` |
| muted | Vyraznejsi na bielom | \`background: ${colors.birneBlack[10]}; color: ${colors.birneBlack[100]};\` |
| dark | Tmavy kruzok | \`background: ${colors.birneBlack[100]}; color: #FFFFFF;\` |
| lemon | Zlty kruzok | \`background: ${colors.birneLemon[100]}; color: ${colors.birneBlack[100]};\` |
| purple | Fialovy kruzok | \`background: ${colors.birnePurple[80]}; color: ${colors.birneBlack[100]};\` |
...
\`\`\`html
<div style="width: 40px; height: 40px; min-width: 40px; border-radius: 50%; background: ${colors.birneBlack[5]}; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
  <!-- SVG ikona sem -->
</div>
\`\`\`
...
\`\`\`html
<p style="font-family: 'JetBrains Mono', monospace; font-size: 14px; line-height: 20px; font-weight: 400; letter-spacing: 0.05em; text-transform: uppercase; color: ${colors.birneBlack[40]};">TEXT</p>
\`\`\`
...
| Styl | Inline CSS |
|------|------------|
| Heading (h1) | \`font-family: 'Conforto', serif; font-size: ${typography.fontSize['4xl']}; line-height: ${typography.lineHeight['4xl']}; font-weight: 400; color: ${colors.birneBlack[100]};\` |
| Heading (h2) | \`font-family: 'Conforto', serif; font-size: ${typography.fontSize['3xl']}; line-height: ${typography.lineHeight['3xl']}; font-weight: 400; color: ${colors.birneBlack[100]};\` |
| Heading (h3) | \`font-family: 'Conforto', serif; font-size: ${typography.fontSize['2xl']}; line-height: ${typography.lineHeight['2xl']}; font-weight: 400; color: ${colors.birneBlack[100]};\` |
| Heading (h4) | \`font-family: 'Conforto', serif; font-size: ${typography.fontSize.xl}; line-height: ${typography.lineHeight.xl}; font-weight: 500; color: ${colors.birneBlack[100]};\` |
| Body (md) | \`font-family: 'General Sans', sans-serif; font-size: ${typography.fontSize.md}; line-height: 25px; color: #514A53;\` |
| Body (base) | \`font-family: 'General Sans', sans-serif; font-size: ${typography.fontSize.base}; line-height: ${typography.lineHeight.base}; color: #514A53;\` |
| Body (sm) | \`font-family: 'General Sans', sans-serif; font-size: ${typography.fontSize.sm}; line-height: ${typography.lineHeight.sm}; color: #514A53;\` |
| Label | \`font-family: 'General Sans', sans-serif; font-size: ${typography.fontSize.sm}; line-height: ${typography.lineHeight.sm}; font-weight: 500;\` |
| Caption | \`font-family: 'General Sans', sans-serif; font-size: ${typography.fontSize.xs}; line-height: ${typography.lineHeight.xs}; color: ${colors.birneBlack[40]};\` |
`;
}
...
function build() {
  ...
  // Generate Components Inline CSS Markdown
  console.log('  📄 Generating components inline CSS...');
  const componentsPath = path.join(distDir, 'markdown', 'components-inline.md');
  fs.writeFileSync(componentsPath, generateComponentsInlineMarkdown());
  ...
  if (fs.existsSync(generatorsPath)) {
    ...
    fs.copyFileSync(componentsPath, path.join(generatorsPath, 'components-inline.md'));
    console.log('  📋 Copied brand-tokens.md to birne-generators');
    console.log('  📋 Copied components-inline.md to birne-generators');
  }
  ...
  console.log('   dist/markdown/components-inline.md');
}
